...
<font color="#FF0004">Transaction Date :      <input type="text" name="am" value='<?php echo $date; ?>' readonly></font>
 ...
 <button type="button" name="pr" onClick="window.print() ">Print this receipt</button>     <input type="submit" name="pr2" formaction="final_form2_start.php" value="Generate form">
