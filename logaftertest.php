...
<th style="background-color:#309; color:#FFF"> COURSE APPLIED </th><th style="background-color:#309; color:#FFF"> COURSE CODE </th><th style="background-color:#309; color:#FFF"> SELECTION STATUS </th><th style="background-color:#309; color:#FFF"> PAYMENT STATUS </th>
</tr>
...
<td><center><?php echo $s_status ?></center></td>
...
<br />
<input type="submit" value="log out" name="b24" id="b24" />
</form>
